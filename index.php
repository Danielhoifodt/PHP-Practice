...
if(isset($_POST["edit"])){
    ...
    //$data = ['text_content'=>$text_content_new, 'id'=>$id];
    ...
    <div class="container border">
        ...
        <div class="row">
            <div class="col-7">
                ...
                ?>
                <li class="list-group-item"><?php echo $text_content;?><div class="float-right"><a id="button_change" style="color:#62bfcc;" onclick="onButtonEdit(<?php echo $id;?>);">Endre</a>&nbsp;&nbsp;<a style="color:red;" href="index.php?del_task=<?php echo $id;?>">Slette</a></div></li>
            <?php } ?>
            </ul>
            </div>
        </div>
